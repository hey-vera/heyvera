...
- Name: e2e/signed-out.spec.ts >> Signed-out user experience >> redirects to auth when trying to access protected pages
- Location: tests/e2e/signed-out.spec.ts:50:3
