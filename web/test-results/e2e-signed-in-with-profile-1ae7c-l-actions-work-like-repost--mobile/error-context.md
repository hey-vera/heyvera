...
- Name: e2e/signed-in-with-profile.spec.ts >> Signed-in user with profile >> social actions work (like, repost)
- Location: tests/e2e/signed-in-with-profile.spec.ts:129:3
