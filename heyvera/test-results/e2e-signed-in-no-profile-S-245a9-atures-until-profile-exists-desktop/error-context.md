...
- Name: e2e/signed-in-no-profile.spec.ts >> Signed-in user without profile >> blocked from social features until profile exists
- Location: tests/e2e/signed-in-no-profile.spec.ts:67:3
