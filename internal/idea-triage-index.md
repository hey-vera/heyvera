...
| Cortex Operations Room foundation | `internal/backlog/cortex-operations-room-foundation-checklist.md`, `docs/proposals/live-orchestration-mapping-view.md`, `internal/vision/cortex.md` | cross-repo | discovery | medium-high | proposal | Serious product architecture direction; requires event-log, verifier, authority, GitHub trust, and conflict-control proposal before implementation. |
