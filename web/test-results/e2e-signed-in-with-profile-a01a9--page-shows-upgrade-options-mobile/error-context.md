...
- Name: e2e/signed-in-with-profile.spec.ts >> Signed-in user with profile >> premium page shows upgrade options
- Location: tests/e2e/signed-in-with-profile.spec.ts:222:3
