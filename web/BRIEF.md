...
Build one section at a time. Start with the project setup (Vite + React
+ Tailwind), then Navbar, then Hero, then work down the page. Show the
developer what you're doing as you go. Keep the code simple and clean.
