...
- **Revenue split (providers, founding era):**
  - Founding: 0% fee — 100% provider on live calls, 50% of cache revenue (pure profit)
  - After Soma Heart launch: 10% fee — 90% provider on live, 50% of cache revenue
  - Token staking reduces fee from 10% down to 3%
