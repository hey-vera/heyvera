...
When Vera Socials becomes production-wired, do not treat it like a
generic social CRUD app first.

The cross-system Soma synthesis strengthens this order:

1. HeyVera remains the human-facing shell
2. Vera remains the shared-intelligence layer
3. Soma remains the deep continuity, authority, delegation, and proof
   substrate

That means production social wiring should preserve:
- account identity versus agent identity
- linked-agent relationships
- future Soma-backed auth/session migration room
- future Soma-backed approval and entitlement room
- proof and continuity fields near social objects

Practical implication:
- social schema and API work can begin
- but they should not hard-code Clerk/account-table truth as the final
  model
- profile, post, follow, community, and linked-agent tables should be
  designed with migration room for Soma-rooted identity and authority
