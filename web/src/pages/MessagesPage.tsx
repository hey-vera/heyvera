    ...
    return (
      ...
      >
        <div className="flex w-full flex-col">
          <div
            className="sticky top-[var(--top-bar-height)] z-10 border-b bg-black/80 px-4 py-3 backdrop-blur-md lg:top-0"
      ...
      >
        {!selectedConversation ? (
          ...
          <>
            {/* Thread header */}
            <div
              className="sticky top-[var(--top-bar-height)] z-10 flex items-center gap-3 border-b bg-black/80 px-4 py-3 backdrop-blur-md lg:top-0"
              style={{ borderColor: 'var(--border-primary)' }}
            >
