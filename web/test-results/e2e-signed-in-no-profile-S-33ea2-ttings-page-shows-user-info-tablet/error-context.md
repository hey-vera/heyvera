...
- Name: e2e/signed-in-no-profile.spec.ts >> Signed-in user without profile >> settings page shows user info
- Location: tests/e2e/signed-in-no-profile.spec.ts:108:3
