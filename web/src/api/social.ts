...
export async function likePost(id: string, token?: string): Promise<void> {
  ensureLegacyApiBase();
  if (!token) throw new Error('Auth token required');
  return legacyFetchAuthedApi<void>(`/posts/${id}/like`, token, { method: 'POST' });
}
...
export async function unlikePost(id: string, token?: string): Promise<void> {
  ensureLegacyApiBase();
  if (!token) throw new Error('Auth token required');
  return legacyFetchAuthedApi<void>(`/posts/${id}/like`, token, { method: 'DELETE' });
}
...
export async function repostPost(id: string, token?: string): Promise<void> {
  ensureLegacyApiBase();
  if (!token) throw new Error('Auth token required');
  return legacyFetchAuthedApi<void>(`/posts/${id}/repost`, token, { method: 'POST' });
}
...
export async function bookmarkPost(id: string, token?: string): Promise<void> {
  ensureLegacyApiBase();
  if (!token) throw new Error('Auth token required');
  return legacyFetchAuthedApi<void>(`/posts/${id}/bookmark`, token, { method: 'POST' });
}
...
export async function unbookmarkPost(id: string, token?: string): Promise<void> {
  ensureLegacyApiBase();
  if (!token) throw new Error('Auth token required');
  return legacyFetchAuthedApi<void>(`/posts/${id}/bookmark`, token, { method: 'DELETE' });
}
