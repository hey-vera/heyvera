...
- Name: e2e/signed-in-no-profile.spec.ts >> Signed-in user without profile >> auth works and user is recognized
- Location: tests/e2e/signed-in-no-profile.spec.ts:19:3
