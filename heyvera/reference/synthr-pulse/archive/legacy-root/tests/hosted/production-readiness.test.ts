...
describe("production readiness", () => {
  ...
  it("blocks relative or temporary persistence paths for strict customer launch", () => {
    ...
    expect(codes).toContain("HOSTED_DB_PATH_NOT_ABSOLUTE");
    // Accept either temp or not-found depending on fs/env in this run
    expect(codes.some(c => c.includes("PULSE_HEART_PATH"))).toBe(true);
  });
