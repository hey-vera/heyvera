...
| Cortex Operations Room foundation | `internal/backlog/cortex-operations-room-foundation-checklist.md`, `docs/proposals/cortex-operations-room-contract.md`, `docs/reference/cortex-operations-room.md`, `docs/proposals/live-orchestration-mapping-view.md`, `internal/vision/cortex.md` | cross-repo | proposal | medium-high | implementation slices | Product/surface contract promoted; next implementation slices are event log, task-run binding, task inspector projection, evidence gate, and leases. |
