...
The term "cache hit" in `docs/billing.md` (written before Soma Check existed) refers to **ClawNet's internal cache only**. When reading old docs or code comments:
